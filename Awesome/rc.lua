...
-- Botón izquierdo, derecho, rueda en el símbolo del diseño 	Conmuta entre el diseño anterior y el siguiente
-- Boton de la rueda en el nombre de la etiqueta		Mata la estiqueta/ventana seleccionada

-- #########################Atajos de teclado

-- Win + f			Ejecuta la aplicación "Firefox"
-- Win + s			Ejecuta la aplicacion "SpaceFM"
-- Win + c			Ejecuta la aplicacion "Cherrytree"
-- Win + d			Ejecuta la aplicacion "Darktable"
-- Win + p			Ejecuta la aplicacion "Oblogout"
...
run_once("numlockx")
run_once("xset -b")
run_once("mpd /home/morta/.mpd/config")
...
beautiful.init("/home/morta/.config/awesome/themes/default/theme.lua")
...
tags = {
        names = { "Terminal","Internet","Explorador","Social","Descargar","Multimedia","Fotografia","Otros" },
        layout = {layouts[2], layouts[1], layouts[2], layouts[2], layouts[2], layouts[4], layouts[1], layouts[3]}
        }
for s = 1, screen.count() do
...
--    awful.key({ modkey,           }, "Escape",      awful.tag.history.restore),
    ...
    awful.key({ modkey,           }, "c", function () awful.util.spawn("cherrytree") end),
    awful.key({ modkey,           }, "d", function () awful.util.spawn("darktable") end),
    awful.key({ 		  }, "Print", function () awful.util.spawn("scrot") end),
    awful.key({ modkey,           }, "p", function () awful.util.spawn("oblogout") end),
    ...
    awful.key({ modkey,		  }, "KP_Subtract", function () awful.util.spawn("amixer sset Master 2dB- unmute")end),
    awful.key({ modkey,		  }, "KP_Add", function () awful.util.spawn("amixer sset Master 2dB+ unmute")end),
    awful.key({ modkey,		  }, "e", function () awful.util.spawn("gvim /home/morta/.config/awesome/rc.lua") end),
...
awful.rules.rules = {
    ...
    -- Set Pidgin to always map on tags number 4 of screen 1.
    { rule = { class = "Pidgin" },
      properties = { tag = tags[1][4] } },
    -- Set Skype to always map on tags number 4 of screen 1.
    { rule = { class = "Skype" },
      properties = { tag = tags[1][4] } },
    -- Set MPlayer to always map on tags number 6 of screen 1.
    { rule = { class = "MPlayer" },
      properties = { tag = tags[1][6] } },
    -- Set Transmission to always map on tags number 6 of screen 1.
